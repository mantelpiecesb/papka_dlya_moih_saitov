...
const monsterImgs = ['images/monster-1.png', 'images/monster-2.png', 'images/monster-3.png', 'images/monster-4.png']
  ...
  let laserInterval = setInterval(() => {
    ...
    monsters.forEach(monster => {
      if (checkLaserCollision(laser, monster)) {
        let explosion = new Audio('audio/vova1.mp3');
        let explosion2 = new Audio('audio/vova1.mp3');
        let explosion3 = new Audio('audio/petya1.mp3');
        let explosion4 = new Audio('audio/petya2.mp3');
        let explosion5 = new Audio('audio/tolya1.mp3');
        let explosion6 = new Audio('audio/vova2.mp3');
        let explosion7 = new Audio('audio/daniil_laugh.mp3');
        let explosion8 = new Audio('audio/valera1.mp3');
        let explosion_arr = [explosion, explosion2,explosion3, explosion4,explosion5,explosion6,explosion7,explosion8];
        let test_random = getRandomInt(8);
        explosion_arr[test_random].play()
...
function gameOver() {
  ...
  justice.pause()
  let gameOverSfx = new Audio('audio/daniil2.mp3')
  gameOverSfx.playbackRate = 0.5;
  gameOverSfx.play()
  ...
  setTimeout(() => {
    alert(`Даниил всё-таки смог вторгнуться на Землю. Ты набрала очков - ${scoreCounter.innerText}!`)
